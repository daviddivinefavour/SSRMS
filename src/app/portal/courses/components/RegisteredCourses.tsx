...
// export const RegisteredCourseList = ({
//   userId,
//   sessionId,
// }: {
//   userId: string
...
//     const url = `/api/registered-courses?sessionId=${sessionId}&userId=${userId}`
//     const response = await fetch(url)
//     const res = await response.json()
//     return res.data
//   }

//   const { data, error, isLoading } = useQuery('courses', fetchEnrolledCourses)
